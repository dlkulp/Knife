	...
	<div class="row">
		<div id="slideshow" class="col l5 push-l2">
			...
			<div id="metadata" class="row col l12">
				...
				<div class="col l9">
					<textarea rows="200">{{{game.desc}}}</textarea>
				</div>
			</div>
		</div>
        <div id="sidebar" class="col l3 push-l2 white z-depth-1">
            <a class="dropdown-button btn"" href="#" data-activates="teams"> Team <i class="material-icons right">keyboard_arrow_down</i></a>
            <ul id="teams" class="dropdown-content">
                <li v-for="team in user.teams"><a>{{team.title}}</a></li>
            </ul>
            <br />
            <a class="waves-effect waves-light btn">Delete Game</a>
            <br />
            <a class="waves-effect waves-light btn">Update Information</a>
		</div>
	</div>
</template>
		...
		data () {
			return {
                user: {
					...
					tagLine: "I like big data and I cannot lie, you other programmers cannot lie.", 
					loc: "San Francisco, USA",
					media: [{text:"Github", link:"https://github.com/bromanko"}, {text:"Docker", link:"https://hub.docker.com/u/bromanko/"}, {text:"Personal Site", link:"http://bromanko.com"}],
					...
					teams: [
						{title: "Ubisoft Montréal", desc: "Canadian Games", link: "../../assets/team.jpg", slug:"ubisoft-montreal" },
                        {title: "Blizzard Studios", desc: "him", link: "../../assets/blizzard.jpg", slug:"blizzard_studios" }
					],
					games: [
