<template>
	...
	<div class="row">
		<div id="slideshow" class="col l5 push-l2">
			...
			<div id="metadata" class="row col l12">
				...
				<div class="col l3">
					...
					<ul class="z-depth-1">
						<h5>Downloads</h5>
						<li><a v-bind:href="game.download">Download Here</a></li>
					</ul>
		...
		<div id="sidebar" class="col l3 push-l2 white z-depth-1">
			<sidebar v-bind:studio="game.studio"></sidebar>
		</div>
	</div>
</template>
